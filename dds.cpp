...
int main() {
    ...
    vector<vector<int>> C_auto_t = wczytaj_tablice_wektorow("PRE_C_wspolautorzy_od_t.txt"); 
    vector<vector<int>> C_obce_t = wczytaj_tablice_wektorow("PRE_C_obce3_od_t.txt"); 
